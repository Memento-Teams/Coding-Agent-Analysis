...
- [Chapter 0: 0.2 工具系统概览](../Chapter-0/02-tool-architecture.md) — 工具分类全景
- [Chapter 2: 2.4.4 工具执行](../Chapter-2/24-query-loop.md#244-阶段-3工具执行--并行还是串行) — 引擎如何调用工具
- [Chapter 2: 2.4.7 Tool 接口](../Chapter-2/24-query-loop.md#247-tool-接口--工具的契约) — 工具契约
