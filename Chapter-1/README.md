...
阅读本章前，建议先完成 [Chapter 0: 项目概览](../Chapter-0/README.md)，特别是：
- [0.0 全局架构总览](../Chapter-0/00-architecture-overview.md) — 理解各层的位置
- [0.1 启动流程概览](../Chapter-0/01-boot-sequence.md) — 本章是这张时序图的"放大版"
